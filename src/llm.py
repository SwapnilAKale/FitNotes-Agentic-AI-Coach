...
_EXPLAIN_SYSTEM = (
    ...
    "Quick reference -- which exercises report in which unit:\n"
    "  Report in KG: Deadlift (from 2025-12-26), Seated Machine Curl (Kg), Machine Wrist Extension, Hand Gripper\n"
    "  Report in LBS: everything else\n\n"
    ...
    "If in doubt about the unit, look at the SQL column name.\n"
)
